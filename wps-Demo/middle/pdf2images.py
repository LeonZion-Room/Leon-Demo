...
# ----------------- 界面代码（PyQt5） -----------------
from PyQt5.QtCore import Qt, QThread, pyqtSignal, QPoint, QUrl, QSize, QTimer
    ...
    def _apply_responsive_sizes(self):
        ...
        try:
            ...
            for w in (
                ...
                w.setMinimumHeight(H(32))

            self.btn_convert.setMinimumHeight(H(36))
            self.btn_open_out.setMinimumHeight(H(36))
            self.progress_bar.setMinimumHeight(H(22))
